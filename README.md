...
- This applications permission requirements are controlled through the config.ini setting and can be adjusted to meet your specific required of the individual storaage devices.
...
- **Safety First:** This software is specifically designed to identify, target, and test removable storage devices. It is designed to  **never** perform stress testing on the system's main (C:) drive.
