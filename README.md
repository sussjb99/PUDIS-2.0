...
- **Safety First:** The software is designed to identify, target, and test removable drives. it is specifically designed **never** to perform stress testing on the system's main (C:) drive.
