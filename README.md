...
- This applications permission requirements are controlled through the config.ini setting and can be adjusted to meet the specific required of your individual storaage devices.
