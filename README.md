...
- **Safety First:** The software is designed to specifically identify, target, and test removable drives. it is designed to  **never** perform stress testing on the system's main (C:) drive.
