...
- **Safety First:** The software is designed to identify, target, and test removable drives and is specifically designed **never** perform stress testing on the system's main (C:) drive.
